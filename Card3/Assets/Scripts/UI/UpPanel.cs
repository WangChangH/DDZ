...
public class UpPanel : UIBase
{
    ...
    {
        imgCards[0].sprite = Resources.Load<Sprite>("MyCard/" + cards[0].Name);
        imgCards[1].sprite = Resources.Load<Sprite>("MyCard/" + cards[1].Name);
        imgCards[2].sprite = Resources.Load<Sprite>("MyCard/" + cards[2].Name);
    }
}
